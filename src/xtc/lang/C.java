...
// on Sunday, 31 March, 2013 at 8:29:18 PM.
 ...
 */
public final class C extends ParserBase {
  ...
  static final class CColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public C(final Reader reader, final String file) {
    super(reader, file);
   ...
   */
  public C(final Reader reader, final String file, final int size) {
  ...
  private Result pDeclarationSpecifiers(final int yyStart) 
    ...
    CColumn yyColumn = (CColumn)column(yyStart);
